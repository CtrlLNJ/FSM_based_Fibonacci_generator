...
HD_PWD='F:/VHDL/VivadoProjects/DDVHD_Lab3B_v2/DDVHD_Lab3B_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fibonacci.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fibonacci.tcl
